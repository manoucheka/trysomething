...
@section('page')
      ...
      <div class="box-typical box-typical-padding">
        ...
        <h5 class="m-t-lg with-border">Doctors Inputs</h5>

                  {!!Html::ul($errors->all())!!}         
       <!-- <form  <form method="post" action="patient" enctype="multipart/form-data"> -->
        {!! Form::open(array('url' => 'doctors', 'role'=>'form','files'=> true)) !!}
  ...
  <div class="form-group row">
            ...
            <div class="col-sm-10">
              <p class="form-control-static"><input type="text" class="form-control"   name="name" placeholder=" your name"></p>
            </div>
  </div>
