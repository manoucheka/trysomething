          ...
          <div class="row">
            <div class="col-lg-6 company-info">
              ...
              <div class="invoice-block">
                <h2>{{$laboratorist->name}}:</h2>

                
                <div>
                  <img src="{{$laboratorist->image}}"  height="180" width="180" class="img-rounded" alt="Visa">
            ...
            <div class="col-lg-5 clearfix">
              <div class="total-amount">
                ...
                <div class="actions">
                  ...
                  <a href="{{ url('admin/laboratorists')}}" class="btn btn-primary">Back</a>
