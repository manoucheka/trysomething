...
@section('page')
          ...
          <div class="tbl-row">
            <div class="tbl-cell">
              <!--<h3>Patients Admin Panel</h3>-->
               <h2 style="padding-left:40px;; color:green">Pharmacists Admin Panel</h2>
              <ol class="breadcrumb breadcrumb-simple">
                <li><a href="{{ url('admin/pharmacists')}}">View All Pharmacists</a></li>
      ...
      <div class="box-typical box-typical-padding">
        ...
        <h5 class="m-t-lg with-border">Pharmacist Inputs</h5>

                  {!!Html::ul($errors->all())!!}         
       <!-- <form  <form method="post" action="patient" enctype="multipart/form-data"> -->
        {!! Form::open(array('url' => 'pharmacists', 'role'=>'form','files'=> true)) !!}
...
<div class="form-group row">
      ...
      <div class="form-group row">
       ...
       <div class="box-footer">
                    ...
                    {!! Form::submit('Create Pharmacist!', array('class'=>'btn btn-primary')) !!}
                  </div>
                <!--</form> -->
                {!! Form::close() !!}
</div>
